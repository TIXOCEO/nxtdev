...
// Sprint 71 — `updateGroupLevelBand` is verwijderd in Sprint 72: de
// vrije-tekst kolom `groups.level_band` is vervangen door het
// gestructureerde `program_stages` + `group_stages` model. Zie
// `lib/actions/tenant/program-stages.ts` voor de opvolger.
